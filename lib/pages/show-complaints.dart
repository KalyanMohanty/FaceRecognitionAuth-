...
class _ShowLogsState extends State<ShowComplaint> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Received Complaints'),
      ...
      body: Container(
        ...
        child: adminList.length == 0
            ...
            : new ListView.builder(
                ...
                itemBuilder: (_, index) {
                  return AdminUI(adminList[index].name,
  ...
  Widget AdminUI(String name, String complaint, String comment) {
    return new Card(
      elevation: 10.0,
